...
class ScrollingTabController: UIViewController {
    ...
    func addItem(item: String, title: String){
        items.append(item)
        titles.append(title)
    }
    ...
    func build(){
        ...
        collectionPage.allowsSelection = false
    }
...
extension ScrollingTabController: UICollectionViewDelegate{
...
extension ScrollingTabController: UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let vc: UIViewController = storyboard.instantiateViewController(withIdentifier: vcName) as UIViewController
...
extension ScrollingTabController: UICollectionViewDelegateFlowLayout{
